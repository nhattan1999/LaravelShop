	...
	<header id="header"><!--header-->
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
                ...
                ?>
                  <li><a href="{{URL::to('/checkout')}}"><i class="fa fa-user"></i> Checkout</a></li>
                <?php
              }  elseif ($customer_id != null && $shipping_id != null){
                ?>
                  <li><a href="{{URL::to('/payment')}}"><i class="fa fa-user"></i> Checkout</a></li>
                <?php
                }  else {
                 ?>
                    <li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-user"></i> Checkout</a></li>
                <?php } ?>
					...
					<div class="col-sm-7">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="{{URL::to('/show-cart')}}">Carts</a></li>
								<li><a href="contact-us.html">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-5">
            <form action="{{URL::to('/find-product')}}" method="post">
              {{csrf_field()}}

...
<script src="{{asset('public/backend/js/form-validator/jquery.form-validator.min.js')}}"></script>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('storage/backend/images/2.png')}}">
                <span class="username">
                  <?php
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
          						...
          						<li><a href="{{URL::to('/view-product')}}">View product</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
